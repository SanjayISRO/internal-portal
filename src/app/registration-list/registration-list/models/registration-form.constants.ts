export const DepartNames = ['Analytics', 'IT Business Apps', 'IT Infrastructure & Admin',
     'Product Development - R&D', 'Product Management', 'Product Support', 'Professional Services', 'Tech pubs', 'Others'];
